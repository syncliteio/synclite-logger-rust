//! DuckDB-backed [`DbDevice`](synclite_db_traits::DbDevice) implementation.
//!
//! Mirrors [`synclite_db_sqlite::SqliteDevice`] but the user-facing database
...
/// See `synclite_db_sqlite::next_monotonic_commit_id` — same algorithm.
