...
Both samples show explicit initialize first via `SyncLite::initialize_with_config_path(DeviceType, db_path, conf_path)`, then open a wrapper connection and run normal SQL operations.
